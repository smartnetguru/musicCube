/* BASSenc 2.3 C/C++ header file, copyright (c) 2003-2007 Ian Luck.
...
typedef void (CALLBACK ENCODENOTIFYPROC)(HENCODE handle, DWORD status, DWORD user);
...
BOOL BASSENCDEF(BASS_Encode_SetNotify)(DWORD handle, ENCODENOTIFYPROC *proc, DWORD user);
...
BOOL BASSENCDEF(BASS_Encode_CastSetTitle)(HENCODE handle, const char *title);
